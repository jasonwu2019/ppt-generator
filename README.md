...
> 🎯 为 WorkBuddy 定制的 ppt-generator Skill | 版本 v3.19
...
- **📸 原生分辨率截图导出**：自动检测显示器原生分辨率（如1280×720），viewport精确匹配像素网格，3× retina（3840×2160 PNG），无UI叠加层纯净幻灯片
...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| v3.19 | 2026-05-29 | **原生分辨率截图**：自动检测显示器分辨率（GetSystemMetrics），viewport = 原生像素网格消除OS缩放失真；隐藏UI叠加层纯幻灯片截图；3×视网膜；元素级截图 |
